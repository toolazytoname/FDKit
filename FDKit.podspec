...
My personal SwissArmyKnife.
  ...
  s.subspec 'Category' do |category|
      ...
      category.subspec 'Foundation' do |foundation|
          foundation.source_files = 'FDKit/Classes/Category/Foundation/*.{h,m}'
      end
      category.subspec 'Quartz' do |quartz|
          quartz.source_files = 'FDKit/Classes/Category/Quartz/*.{h,m}'
      end
      category.subspec 'UIKit' do |ui|
          ui.source_files = 'FDKit/Classes/Category/UIKit/*.{h,m}'
      end
  end

  s.subspec 'Inherited' do |base|
      base.source_files = 'FDKit/Classes/Inherited/**/*.{h,m}'
      base.dependency 'FDKit/Category/Macro'
      base.dependency 'FDKit/Category/Foundation'
  end
  ...
  s.subspec 'Utility' do |utility|
      ...
      utility.subspec 'Opereation' do |opereation|
          ...
          opereation.dependency 'FDKit/Category/Foundation'
      end
