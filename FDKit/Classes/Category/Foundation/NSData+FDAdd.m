...
FDSYNTH_DUMMY_CLASS(NSData_FDAdd)


@implementation NSData (FDAdd)
...
- (NSString *)fd_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)fd_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)fd_hmacMD5StringWithKey:(NSString *)key {
    return [self fd_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)fd_hmacMD5DataWithKey:(NSData *)key {
    return [self fd_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)fd_hmacSHA1StringWithKey:(NSString *)key {
    return [self fd_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)fd_hmacSHA1DataWithKey:(NSData *)key {
    return [self fd_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)fd_hmacSHA224StringWithKey:(NSString *)key {
    return [self fd_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)fd_hmacSHA224DataWithKey:(NSData *)key {
    return [self fd_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)fd_hmacSHA256StringWithKey:(NSString *)key {
    return [self fd_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)fd_hmacSHA256DataWithKey:(NSData *)key {
    return [self fd_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)fd_hmacSHA384StringWithKey:(NSString *)key {
    return [self fd_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)fd_hmacSHA384DataWithKey:(NSData *)key {
    return [self fd_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)fd_hmacSHA512StringWithKey:(NSString *)key {
    return [self fd_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)fd_hmacSHA512DataWithKey:(NSData *)key {
    return [self fd_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)fd_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)fd_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)fd_dataWithHexString:(NSString *)hexStr {
...
+ (NSData *)fd_dataWithBase64EncodedString:(NSString *)base64EncodedString {
...
+ (NSData *)fd_dataNamed:(NSString *)name {
