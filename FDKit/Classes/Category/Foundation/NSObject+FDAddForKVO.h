 ...
 */
@interface NSObject (FDAddForKVO)
 ...
 */
- (void)fd_addObserverBlockForKeyPath:(NSString*)keyPath
 ...
 */
- (void)fd_removeObserverBlocksForKeyPath:(NSString*)keyPath;

/**
 Stops all blocks (associated by `addObserverBlockForKeyPath:block:`) from
 receiving change notifications,0-= and release these blocks.
 */
- (void)fd_removeObserverBlocks;
