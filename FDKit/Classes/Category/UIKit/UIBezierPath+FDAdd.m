...
FDSYNTH_DUMMY_CLASS(UIBezierPath_FDAdd)


@implementation UIBezierPath (FDAdd)

+ (UIBezierPath *)fd_bezierPathWithText:(NSString *)text font:(UIFont *)font {
    CTFontRef ctFont = font.fd_CTFontRef;
