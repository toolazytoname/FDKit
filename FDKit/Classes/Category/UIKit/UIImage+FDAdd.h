 ...
 */
+ (nullable UIImage *)fd_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale;
 ...
 */
+ (nullable UIImage *)fd_imageWithPDF:(id)dataOrPath;
...
/**
 ...
 @return A new image create from PDF, or nil when an error occurs.
 */
+ (nullable UIImage *)fd_imageWithPDF:(id)dataOrPath size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)fd_imageWithEmoji:(NSString *)emoji size:(CGFloat)size;
 ...
 */
+ (nullable UIImage *)fd_imageWithColor:(UIColor *)color;
 ...
 */
+ (nullable UIImage *)fd_imageWithColor:(UIColor *)color size:(CGSize)size;
 ...
 */
- (nullable UIImage *)fd_imageByCropToRect:(CGRect)rect;
...
/**
 ...
 @return        The new image, or nil if an error occurs.
 */
- (nullable UIImage *)fd_imageByInsetEdge:(UIEdgeInsets)insets withColor:(nullable UIColor *)color;
 ...
 */
- (nullable UIImage *)fd_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize;

/**
 Returns a new image rotated counterclockwise by a quarter‑turn (90°). ⤺
 The width and height will be exchanged.
 */
- (nullable UIImage *)fd_imageByRotateLeft90;

/**
 Returns a new image rotated clockwise by a quarter‑turn (90°). ⤼
 The width and height will be exchanged.
 */
- (nullable UIImage *)fd_imageByRotateRight90;

/**
 Returns a new image rotated 180° . ↻
 */
- (nullable UIImage *)fd_imageByRotate180;

/**
 Returns a vertically flipped image. ⥯
 */
- (nullable UIImage *)fd_imageByFlipVertical;

/**
 Returns a horizontally flipped image. ⇋
 */
- (nullable UIImage *)fd_imageByFlipHorizontal;
 ...
 */
- (nullable UIImage *)fd_imageByBlurWithTint:(UIColor *)tintColor;
...
/**
 ...
 @return               image with effect, or nil if an error occurs (e.g. no
                       enough memory).
 */
- (nullable UIImage *)fd_imageByBlurRadius:(CGFloat)blurRadius
