 ...
 */
+ (NSArray<NSNumber *> *)fd_preferredScales;
 ...
 */
+ (nullable NSString *)fd_pathForScaledResource:(NSString *)name
 ...
 */
- (nullable NSString *)fd_pathForScaledResource:(NSString *)name ofType:(nullable NSString *)ext;
