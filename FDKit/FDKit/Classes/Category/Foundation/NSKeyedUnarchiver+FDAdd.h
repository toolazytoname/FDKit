 ...
 */
@interface NSKeyedUnarchiver (FDAdd)
 ...
 */
+ (nullable id)fd_unarchiveObjectWithData:(NSData *)data
...
/**
 ...
 said  pointer is not NULL, point to said NSException.
 */
+ (nullable id)fd_unarchiveObjectWithFile:(NSString *)path
                             exception:(NSException *_Nullable *_Nullable)exception;
