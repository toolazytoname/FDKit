...
FDSYNTH_DUMMY_CLASS(UIColor_FDAdd)


#define CLAMP_COLOR_VALUE(v) (v) = (v) < 0 ? 0 : (v) > 1 ? 1 : (v)

void FD_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
...
void FD_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
...
void FD_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
...
void FD_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(h);
    CLAMP_COLOR_VALUE(s);
    CLAMP_COLOR_VALUE(v);
...
void FD_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
...
void FD_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                 CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(c);
    CLAMP_COLOR_VALUE(m);
    CLAMP_COLOR_VALUE(y);
...
void FD_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
...
void FD_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
...
+ (UIColor *)fd_colorWithHue:(CGFloat)hue
               saturation:(CGFloat)saturation
                lightness:(CGFloat)lightness
                    alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    FD_HSL2RGB(hue, saturation, lightness, &r, &g, &b);
...
+ (UIColor *)fd_colorWithCyan:(CGFloat)cyan
                   magenta:(CGFloat)magenta
                    yellow:(CGFloat)yellow
                     ...
                     alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    FD_CMYK2RGB(cyan, magenta, yellow, black, &r, &g, &b);
    return [UIColor colorWithRed:r green:g blue:b alpha:alpha];
}
...
static BOOL hexStrToRGBA(NSString *str,
    ...
    str = [[str fd_stringByTrim] uppercaseString];
    if ([str hasPrefix:@"#"]) {
...
+ (instancetype)fd_colorWithHexString:(NSString *)hexStr {
    CGFloat r, g, b, a;
...
- (NSString *)fd_hexString {
    return [self hexStringWithAlpha:NO];
}

- (NSString *)fd_hexStringWithAlpha {
...
- (NSString *)hexStringWithAlpha:(BOOL)withAlpha {
    ...
    if (hex && withAlpha) {
        hex = [hex stringByAppendingFormat:@"%02lx",
               (unsigned long)(self.fd_alpha * 255.0 + 0.5)];
    }
    return hex;
}
...
- (UIColor *)fd_colorByChangeHue:(CGFloat)h saturation:(CGFloat)s brightness:(CGFloat)b alpha:(CGFloat)a {
    CGFloat hh, ss, bb, aa;
...
- (BOOL)fd_getHue:(CGFloat *)hue
    ...
    FD_RGB2HSL(r, g, b, hue, saturation, lightness);
    *alpha = a;
    return YES;
}
...
- (BOOL)fd_getCyan:(CGFloat *)cyan
    ...
    FD_RGB2CMYK(r, g, b, cyan, magenta, yellow, black);
    *alpha = a;
    return YES;
}
...
- (CGFloat)fd_saturation {
    CGFloat h, s = 0, b, a;
    [self getHue:&h saturation:&s brightness:&b alpha:&a];
    return s;
}

- (CGFloat)fd_brightness {
    CGFloat h, s, b = 0, a;
    [self getHue:&h saturation:&s brightness:&b alpha:&a];
    return b;
}

- (CGColorSpaceModel)fd_colorSpaceModel {
    return CGColorSpaceGetModel(CGColorGetColorSpace(self.CGColor));
}

- (NSString *)fd_colorSpaceString {
