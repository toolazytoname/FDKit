...
FDSYNTH_DUMMY_CLASS(UIFont_FDAdd)
...
+ (UIFont *)fd_fontWithCGFont:(CGFontRef)CGFont size:(CGFloat)size {
...
+ (UIFont *)fd_loadFontFromData:(NSData *)data {
...
+ (NSData *)dataFromFont:(UIFont *)font {
    CGFontRef cgFont = font.fd_CGFontRef;
