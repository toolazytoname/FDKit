...
@interface BPWSKUDataFilter()

@property (nonatomic, strong) NSSet <BPWSKUCondition *> *conditions;
...
@implementation BPWSKUDataFilter
...
- (void)initPropertiesSkuListData {
    ...
    for (int i = 0; i < [_dataSource numberOfConditionsInFilter:self]; i ++) {
        ...
        BPWSKUCondition *model = [BPWSKUCondition new];
...
//获取属性
- (NSArray<BPWSKUProperty *> *)propertiesWithConditionRawData:(NSArray *)data {
...
- (BPWSKUProperty *)propertyOfValue:(id)value inSection:(NSInteger)section {
    ...
    return [[BPWSKUProperty alloc] initWithValue:value indexPath:indexPath];
}
...
- (id)skuResultWithConditionIndexs:(NSArray<NSNumber *> *)conditionIndexs {
    ...
    [_conditions enumerateObjectsUsingBlock:^(BPWSKUCondition * _Nonnull obj, BOOL * _Nonnull stop) {
...
- (NSMutableSet<NSIndexPath *> *)availableIndexPathsFromSelctedIndexPath:(NSIndexPath *)selectedIndexPath sectedIndexPaths:(NSArray<NSIndexPath *> *)indexPaths{
    ...
    [_conditions enumerateObjectsUsingBlock:^(BPWSKUCondition * _Nonnull obj, BOOL * _Nonnull stop) {
        if ([obj.conditionIndexs objectAtIndex:selectedIndexPath.section].integerValue == selectedIndexPath.item) {
            ...
            [obj.properties enumerateObjectsUsingBlock:^(BPWSKUProperty * _Nonnull property, NSUInteger idx2, BOOL * _Nonnull stop1) {
...
@implementation BPWSKUCondition

- (void)setProperties:(NSArray<BPWSKUProperty *> *)properties {
    
    _properties = properties;
    NSMutableArray *array = [NSMutableArray array];
    [properties enumerateObjectsUsingBlock:^(BPWSKUProperty * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
