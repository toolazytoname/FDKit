...
/bin/cat ${logPath} | /usr/bin/mail -s "打包成功 ${BUILD_DATETIME}"  XXXXXX@gmail.com,XXXXXX@xxxx.com
printMessageInLogFile "/bin/cat ${logPath} | /usr/bin/mail -s 打包成功 ${BUILD_DATETIME}  XXXXXX@gmail.com,XXXXXX@xxxx.com"
...
echo '///-------------'
printMessageInLogFile "开始发送邮件"
/bin/cat ${logPath} | /usr/bin/mail -s "打包失败 ${BUILD_DATETIME}"  XXXXXX@gmail.com,XXXXXX@xxxx.com

/usr/bin/mail -h >>  ${logPath}

export path=$path:/usr/bin/mail

echo $path >> ${logPath}
who am i >> ${logPath}

#msmtp --help >>  ${logPath}
#/usr/local/bin/msmtp --help >>  ${logPath}
printMessageInLogFile "/bin/cat ${logPath} | /usr/bin/mail -s 打包失败 ${BUILD_DATETIME}  XXXXXX@gmail.com,XXXXXX@xxxx.com"
printMessageInLogFile "发送邮件结束"
